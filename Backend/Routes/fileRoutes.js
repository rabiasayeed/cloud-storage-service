...
import { uploadFile, getFiles, renameFile, moveFile, copyFile, deleteFile, getTrash, restoreFile, downloadFile, permanentlyDeleteFile } from "../Controllers/fileController.js";
...
router.get('/:id/download', authMiddleware, downloadFile); router.patch('/:id', authMiddleware, renameFile);
